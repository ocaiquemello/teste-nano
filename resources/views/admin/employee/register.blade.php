                    ...
                    <div class="row">
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                <h2 class="page-header-title">Cadastrar Funcionário</h2>
	                                <div>
                                        <ul class="breadcrumb">
			                                <li class="breadcrumb-item"><a href="{{ route('admin.employee.index') }}"><i class="ti ti-home"></i></a></li>
			                                <li class="breadcrumb-item active">Cadastrar Funcionário</li>
			                            </ul>
	                                </div>
	                            </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="widget has-shadow">
                                ...
                                <div class="widget-body">
                                    ...
                                    @endif
                                    <form class="form-horizontal" method="POST" action="{{ route('admin.employee.create') }}">
                                    @csrf <!-- {{ csrf_field() }} -->
                                        <div class="form-group row d-flex align-items-center mb-5">
                                            <label class="col-lg-3 form-control-label">Nome</label>
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" name="name" placeholder="Insira o nome do funcionário" value="{{ old('name') }}">
                                                @if($errors->has('name'))
                                        ...
                                        <div class="form-group row d-flex align-items-center mb-5">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" name="login" placeholder="Insira o login do funcionário" value="{{ old('login') }}">
                                                @if($errors->has('login'))
                                                    <div class="invalid-feedback" style="display:block !important">
                                                        {{ $errors->first('login') }}
                                                    </div>
                                        ...
                                        <div class="form-group row d-flex align-items-center mb-5">
                                            <label class="col-lg-3 form-control-label">Senha</label>
                                            <div class="col-lg-9">
                                                <input type="password" class="form-control" name="password" placeholder="Insira a senha do funcionário (min. 6 dígitos)">
                                        ...
                                        <div class="form-group row d-flex align-items-center mb-5">
                                            <label class="col-lg-3 form-control-label">Confirmar senha</label>
                                            <div class="col-lg-9">
                                                <input type="password" class="form-control" name="password_confirm" placeholder="Confirme a senha do funcionário">
                                        ...
                                        <div class="form-group row d-flex align-items-center mb-5">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control" name="current_balance" id="current_balance" placeholder="Insira o saldo atual do funcionário" value="{{ old('current_balance') }}">
